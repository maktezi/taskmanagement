...
<div class="col-xl-6 mx-auto">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title text-center">EDIT<br>ASSIGN TASK</h3><br>
            <form action="{{ route('update.assigntask', $data->id) }}" method="POST" class="needs-validation">
                @csrf
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <select name="task_id" class="form-control" required>
                                <option value="{{ $data->task_id }}">{{ $data->task->name }}</option>
                        ...
                        <div class="mb-3">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ ($data->description) }}" type="text" class="form-control" name="description" required/>
                                </div>
                            </div>
                        </div>
                    </div>
